...
const API_FETCH_DROPDOWN = 'backend/class_data_fetch.php';
const API_GET_CLASS = 'backend/manager_class_get.php';
const API_EDIT_CLASS = 'backend/manager_class_edit.php';
